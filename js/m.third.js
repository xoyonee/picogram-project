$(document).ready(function(){
  ...
  const techng = document.getElementsByClassName('techng_box')
  const gnb_r = document.getElementsByClassName('gnb_r')[0];
  const logo = document.getElementsByClassName('logo')[0];
  
  let top_move = document.getElementsByClassName('top_move');
  let right_move = document.getElementsByClassName('right_move');
